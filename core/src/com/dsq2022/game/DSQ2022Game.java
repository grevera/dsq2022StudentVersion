...
public class DSQ2022Game extends Game {
    ...
    //loadPrevious _must_ be false by default. otherwise, v1 (w/ a bad
    // board) will keep being saved and reloaded, and never change (even
    // after the ctor is corrected).
    public boolean loadPreviousOn = false;
    ...
    private void init ( ) {
        ...
        this.loadPreviousOn = prefs.getBoolean( "loadPrevious", false );
        if (this.loadPreviousOn) {
            //load board
